        ...
        <div className="experience">
          <div className="experience-item">
            ...
            <div className="exp-company">
              <span>
                <strong>Total-Tech.</strong>
              </span>
              <span className="exp-date-right">Jan 2026 – Present</span>
            </div>
            <ul>
              <li>
                <span className="li-content">
                  After joining, I independently designed and{" "}
                  <strong>
                    <a
                      href="https://total-tech-seven.vercel.app/"
                      target="_blank"
                      rel="noopener noreferrer"
                  ...
                  the company's official website with complete Development implementation.
                </span>
                <span className="li-links">
                  (
                  <a
                    href="https://totaltechofficial.com/"
                    target="_blank"
                    rel="noopener noreferrer"
              ...
              <li>
                <span className="li-content">
                  ...
                  <strong>
                    <a
                      href="https://tideedry.vercel.app/index.html"
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ color: "#0066cc", textDecoration: "none" }}
                    >
                  ...
                  a professional website for the company's related business.
                </span>
                <span className="li-links">
                  (
                  <a
                    href="https://tideecare.com/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="highlight-text"
                  >
              ...
              <li>
                <span className="li-content">
                  ...
                  US-based client's website redesign project, focusing on UI/UX improvements, performance optimization, responsive design.
                </span>
                <span className="li-links">
                  (
                  <a
                    href="https://amfenglishschool.com/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="highlight-text"
                  >
              ...
              <li>
                <span className="li-content">
                  After completing the initial project,{" "}
                  <strong>
                    <a
                      href="https://geek.vercel.app/"
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ color: "#0066cc", textDecoration: "none" }}
                    >
                  ...
                  working on additional projects for the same US client, delivering solutions efficiently and on time.
                </span>
                <span className="li-links">
                  (
                  <a
                    href="https://geeksupportllc.com/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="highlight-text"
                  >
              ...
              <li>
                <span className="li-content">
                  After the successful completion of the project, I was{" "}
                  <strong>
                    <a
                      href="https://geekrepair.vercel.app/"
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ color: "#0066cc", textDecoration: "none" }}
                    >
                      🔗assigned a new website project
                    </a>
                  </strong>
                  , where I handled the complete design and development.
                </span>
                <span className="li-links">
                  (
                  <a
                    href="https://geekrepairllc.com/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="highlight-text"
                  >
              ...
              <li>
                <span className="li-content">
                  Additionally, I independently designed and developed a{" "}
                  <strong>
                    <a
                      href="https://carrental-blue-ten.vercel.app/"
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ color: "#0066cc", textDecoration: "none" }}
                    >
                  ...
                  for a US client, including a custom admin panel.
                </span>
                <span className="li-links">
                  (
                  <a
                    href="https://luxuryfleetservices.com/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="highlight-text"
                  >
              ...
              <li>
                Consistently completed website projects end-to-end, leading to continuous assignment of new projects and long-term client trust.
              </li>
            </ul>
          </div>
          <div className="experience-item">
            ...
            <div className="exp-company">
              ...
              <span className="exp-date-right">July 2025 – December 2025</span>
            </div>
            <ul>
              <li>
          ...
          <div className="experience-item">
            ...
            <div className="exp-company">
              <span>
                ...
                <a
                  href="https://edunet-food-ordering.vercel.app/"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ color: "red", fontWeight: "bold", textDecoration: "none" }}
                >
              ...
              <span className="exp-date-right">Feb 2025 – March 2025.</span>
            </div>
            <ul>
              <li>
                Worked as a MERN Stack Developer Intern at Edu Net Foundation,
                developing full-stack applications using MongoDB, Express.js,
                React, and Node.js, gaining hands-on experience in
                authentication, CRUD operations, optimization, deployment &
                version control, successfully building a Zomato clone project.
              </li>
            </ul>
          </div>
          <div className="experience-item">
            <div className="exp-header">
              <h4>Web Full Stack Developer Intern: –</h4>
              <span className="exp-location">Remote.</span>
            </div>
            <div className="exp-company">
              <span>
                <strong>EduSkills Academy.</strong>{" "}
                <a
                  href="https://mnish-p.vercel.app/"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ color: "red", fontWeight: "bold", textDecoration: "none" }}
                >
              ...
              <span className="exp-date-right">Jan 2025 – March 2025.</span>
            </div>
            <ul>
              <li>
                After learning key web technologies through this program,
                applied the knowledge by creating a{" "}
                <strong>dynamic personal portfolio website</strong>{" "}
                from scratch — focusing on clean UI design, smooth animations,
                and showcasing projects in an interactive and professional manner.
              </li>
            </ul>
          </div>
          <div className="experience-item">
            ...
            <ul>
              ...
              <li>(Complete More internship)</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="section">
        ...
        <ul className="certifications">
          ...
          <li>
            ...
            <strong>Tailwind</strong>, <strong>Bootstrap</strong>,{" "}
          ...
          <li>
            Basic knowledge in <strong>PHP</strong>.
          </li>
          <li>
            Basic knowledge in <strong>GoDaddy</strong>,{" "}
            <strong>Vercel</strong>.
          </li>
          <li>
            Knowledge in <strong>SEO</strong>,{" "}
      ...
      <section className="section">
        ...
        <div className="projects">
          ...
          <p className="projects-completed" style={{ textAlign: "center" }}>
            <strong>Completed more than 21+ projects.</strong>
            ...
            <div className="projects-modal-body">
              <div className="table-responsive">
                <table className="projects-table">
                  ...
                  <tbody>
                    {/* Personal Projects */}
                    <tr className="table-category-row personal-category-row">
                      <td colSpan="3">
                    ...
                    <tr>
                      <td className="project-name-cell">Password Generator</td>
                      <td className="project-url-cell">psswrd-p-g.vercel.app</td>
                      <td className="project-action-cell">
                        <a href="https://psswrd-p-g.vercel.app/" target="_blank" rel="noopener noreferrer" className="project-link-btn">
                          View <span>→</span>
                        </a>
                      </td>
                    </tr>
                    <tr>
                      <td className="project-name-cell">Tic Tac Toe Game</td>
                      <td className="project-url-cell">tttgme.tiiny.site</td>
                      <td className="project-action-cell">
                        <a href="https://tttgme.tiiny.site/" target="_blank" rel="noopener noreferrer" className="project-link-btn">
                          View <span>→</span>
                        </a>
                      </td>
                    </tr>
                    <tr>
                      <td className="project-name-cell">Password Generator</td>
                      <td className="project-url-cell">password-generator-alpha...</td>
                      <td className="project-action-cell">
                        <a href="https://password-generator-alpha-two-91.vercel.app/" target="_blank" rel="noopener noreferrer" className="project-link-btn">
                          View <span>→</span>
                        </a>
                      </td>
                    </tr>
                    ...
                    {/* Client Projects */}
                    <tr className="table-category-row client-category-row">
                      <td colSpan="3">
                        <span className="category-icon">
                          <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <tr>
                      <td className="project-name-cell">Total-Tech</td>
                      <td className="project-url-cell">totaltechofficial.com</td>
                      <td className="project-action-cell">
                        <a href="https://totaltechofficial.com/" target="_blank" rel="noopener noreferrer" className="project-link-btn">
                          View <span>→</span>
                        </a>
                      </td>
                    </tr>
                    <tr>
                      <td className="project-name-cell">Tideecare</td>
                      <td className="project-url-cell">tideecare.com</td>
                      <td className="project-action-cell">
                        <a href="https://tideecare.com/" target="_blank" rel="noopener noreferrer" className="project-link-btn">
                          View <span>→</span>
                        </a>
                      </td>
                    </tr>
                    <tr>
                      <td className="project-name-cell">AMF English School</td>
                      <td className="project-url-cell">amfenglishschool.com</td>
                      <td className="project-action-cell">
                        <a href="https://amfenglishschool.com/" target="_blank" rel="noopener noreferrer" className="project-link-btn">
                          View <span>→</span>
                        </a>
                      </td>
                    </tr>
                    <tr>
                      <td className="project-name-cell">Geek Support LLC</td>
                      <td className="project-url-cell">geeksupportllc.com</td>
                      <td className="project-action-cell">
                        <a href="https://geeksupportllc.com/" target="_blank" rel="noopener noreferrer" className="project-link-btn">
                          View <span>→</span>
                        </a>
                      </td>
                    </tr>
                    <tr>
                      <td className="project-name-cell">Geek Repair LLC</td>
                      <td className="project-url-cell">geekrepairllc.com</td>
                      <td className="project-action-cell">
                        <a href="https://geekrepairllc.com/" target="_blank" rel="noopener noreferrer" className="project-link-btn">
                          View <span>→</span>
                        </a>
                      </td>
                    </tr>
                    <tr>
                      <td className="project-name-cell">Luxury Fleet Services</td>
                      <td className="project-url-cell">luxuryfleetservices.com</td>
                      <td className="project-action-cell">
                        <a href="https://luxuryfleetservices.com/" target="_blank" rel="noopener noreferrer" className="project-link-btn">
                          View <span>→</span>
                        </a>
                      </td>
                    </tr>
                    <tr>
                      <td className="project-name-cell">Rama Overseas</td>
                      <td className="project-url-cell">rama-overseas-a.vercel.app</td>
                      <td className="project-action-cell">
                        <a href="https://rama-overseas-a.vercel.app/" target="_blank" rel="noopener noreferrer" className="project-link-btn">
                          View <span>→</span>
                        </a>
                      </td>
                    </tr>
                    <tr>
                      <td className="project-name-cell">Godex Printer India</td>
                      <td className="project-url-cell">godexprinterindia.in</td>
                      <td className="project-action-cell">
                        <a href="https://godexprinterindia.in/" target="_blank" rel="noopener noreferrer" className="project-link-btn">
                          View <span>→</span>
                        </a>
                      </td>
                    </tr>
                    <tr>
                      <td className="project-name-cell">Zebra Printers India</td>
                      <td className="project-url-cell">zebraprintersindia.com</td>
                      <td className="project-action-cell">
                        <a href="https://zebraprintersindia.com/" target="_blank" rel="noopener noreferrer" className="project-link-btn">
                          View <span>→</span>
                        </a>
                      </td>
                    </tr>
                    <tr>
                      <td className="project-name-cell">Tags India</td>
                      <td className="project-url-cell">tagsindia.com/user/orders</td>
                      <td className="project-action-cell">
                        <a href="https://tagsindia.com/user/orders" target="_blank" rel="noopener noreferrer" className="project-link-btn">
                          View <span>→</span>
                        </a>
                      </td>
                    </tr>
                    <tr>
                      <td className="project-name-cell">TSC Printers India</td>
                      <td className="project-url-cell">tscprintersindia.com</td>
                      <td className="project-action-cell">
                        <a href="https://www.tscprintersindia.com/" target="_blank" rel="noopener noreferrer" className="project-link-btn">
                          View <span>→</span>
                        </a>
                      </td>
                    </tr>
                    <tr>
                      <td className="project-name-cell">TSC Thermal Transfer Ribbons</td>
                      <td className="project-url-cell">thermaltransferribbons.tscprinters.co.in</td>
                      <td className="project-action-cell">
                        <a href="https://thermaltransferribbons.tscprinters.co.in/" target="_blank" rel="noopener noreferrer" className="project-link-btn">
                          View <span>→</span>
                        </a>
                      </td>
                    </tr>
                    <tr>
                      <td className="project-name-cell">Mindware Thermal Transfer Ribbons</td>
                      <td className="project-url-cell">thermaltransferribbons.mindwareindia.com</td>
                      <td className="project-action-cell">
                        <a href="https://www.thermaltransferribbons.mindwareindia.com/" target="_blank" rel="noopener noreferrer" className="project-link-btn">
                          View <span>→</span>
                        </a>
                      </td>
                    </tr>
            ...
            <div className="modal-body">
              ...
              <p style={{ textAlign: "center", marginTop: "16px" }}>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ color: "red", fontWeight: "bold", textDecoration: "none", fontSize: "16px" }}
                >
                  (Live)
                </a>
              </p>
